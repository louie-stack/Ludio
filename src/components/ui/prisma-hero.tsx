...
const PrismaHero = () => {
  return (
    <section id="hero" className="w-full" style={{ height: "100svh" }}>
      <div className="relative h-full w-full overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200'><filter id='n'><feTurbulence type='fractalNoise' baseFrequency='0.85' numOctaves='2' stitchTiles='stitch' seed='4'/></filter><rect width='100%25' height='100%25' filter='url(%23n)' opacity='0.65'/></svg>\")",
          ...
          <div className="grid grid-cols-12 items-end gap-4">
            ...
            <div className="col-span-12 flex flex-col gap-4 sm:gap-5 pb-8 sm:pb-6 lg:col-span-4 lg:pb-10">
              ...
              <motion.a
                ...
                style={{ backgroundColor: CREAM, color: "#000" }}
              >
                Start a project
                <span
